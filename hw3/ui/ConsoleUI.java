...
public class ConsoleUI {
	...
	public static final String[] test3 = { "#######", "##$ o #", "#     #", "#  @  #", "#     #", "#######" };

	// spikes are deadly if you hit the pointy end (but ok on the side)
	public static final String[] test4 = { "#######", "## v  #", "#  @  #", "#     #", "#  $ ##", "#@    #", "#^    #",
			"#######" };

	// 'O' is a portal
	public static final String[] test5 = { "######", "#O  $#", "# @@ #", "#    #", "#@O ##", "#  ###", "######" };

	// the '+' represents a "moveable block" that can be pushed
	public static final String[] test6 = { "######", "#   ##", "#$ o #", "# @  #", "# +@ #", "#    #", "#    #",
			"######" };
	...
	public static final String[] test8 = { " ##### ", "#....##", "#$.O.@#", "#....##", "#.O...#", "#..+..#", "#^.##@#",
			" ##### " };

	// we can have multiple pairs of portals ('A', 'B')
	public static final String[] test9 = { "##### ####", "#  v     #", "#  @   A #", "   @##   $", "#A      ##",
			"#@ B   @ #", "#       ##", "#^   B @ #", "##### ####" };
