...
/**
 * Utilities for Strings to represent grid and cell information in the
 * CS227Quell game.
 * 
 * @author smkautz
 */
public class StringUtil {
	...
	/**
	 * Basic character representations of cell states, corresponding to CellState
	 * values.
	 */
	public static final char[] TEXT = { '.', // EMPTY,
			'#', // WALL,
			'@', // PEARL,
			'o', // OPEN_GATE,
			'x', // CLOSED_GATE,
	...
	/**
	 * Character for representing the player position in the grid, when the player
	 * lands on a portal
	 */
	 ...
	 * 
	 * @param s a CellState
	 * @return character for the given state
	 */
	...
	/**
	 * Returns the CellState corresponding to the given character, if possible. Any
	 * capital letter in the range 'A' - 'Z' is treated as a portal.
	 * 
	 * @param c given character
	 * @return CellState corresponding to the given character, of null if the
	 *         character does not correspond to a CellState
	 */
	...
	/**
	 * Initializes a cell grid from an array of strings. All strings must be the
	 * same length and may include the characters from TEXT, the PLAYER_CHAR, and
	 * capital letters 'A' - 'Z'. Spaces are also treated as empty cells. Each
	 * string represents one row of the grid. Capital letters represent portals, and
	 * therefore any capital letters must occur exactly twice in the string array.
	 * This method will identify pairs of portals and calculate the correct row and
	 * column offsets.
	 * 
	 * @param strings array of strings representing an initial game grid
	 * @return 2D array of cell object constructed from the string array
	 */
	...
	/**
	 * Converts a grid to a string array representation using the characters defined
	 * in this class. All portals will be represented as the 'O' character. The
	 * returned array has one string per row of the grid.
	 * 
	 * @param grid given 2D array of cells
	...
	/**
	 * Converts the given game's grid to a string array representation using the
	 * characters defined in this class. All portals will be represented as the 'O'
	 ...
	 * representations defined in this class. This method does not calculate portal
	 * offsets.
	 * 
	 * @param text given string
	 * @return Cell array constructed from the string
	 */
	 ...
	 * @return string representation of the Cell array
	 */
	...
	/**
	 * Prints an array of Cells using the character representations defined in this
	 * class.
	 * 
	 ...
	 * 
	 * @param strings array of strings, one per row of the grid
	 */
