...
public class Die //implements Comparable<Die>
{
  ...
  /**
   * Compares this die to another die for order.  Dice are ordered first
   * by value; dice with the same value are ordered by max value, and dice
   * with the same value and max value are ordered by whether they are
   * available, with available dice preceding non-available dice.
   * @param other
   *   the die to which this one is being compared for order
   * 
   */
//  @Override
